          ...
          <div style={{width:'300px', height:'400px'}}>
            <ul className="nav nav-tabs">
              <li className='nav-item'>
                <a href='#register' data-bs-toggle='tab' className='nav-link active' >User Register</a>
              </li>
              <li className='nav-item'> <a href="#login" data-bs-toggle='tab' className='nav-link'>User Login</a>
              </li>
            </ul>
